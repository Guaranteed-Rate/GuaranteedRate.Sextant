...
/// <summary>
/// This is a copy of:
/// https://github.com/TinyBlueRobots/Serilog.Enrichers.AssemblyName/blob/master/Serilog.Enrichers.AssemblyName/AssemblyNameLoggerConfigurationExtensions.cs
/// 
/// This library is only available for 4.6.2, and as such, we've copied it over into this 4.5.2 library.
/// This should be eliminated, and we should use the package, when/if we go to a higher .Net version 
/// 
/// - Harry Cordewener
/// </summary>
namespace Serilog
